        ...
        <div class="row">
            <div class="col-md-12">
                <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                    <div class="mr-auto">
                        <a href="<?php echo site_url('/rent/'); ?>" class="icon-view view-module active"><span class="icon-view_module"></span></a>
                ...
                <?php if (have_rows('details', $page_id)): ?>
                    <div class="row mb-5">
                        ...
                        while (have_rows('details', $page_id)): the_row();
                            ...
                            if (is_array($tags) && in_array('rent', $tags)):
                        ?>
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="property-entry h-100">
                                        <a href="<?php echo site_url('index.php/property'); ?>" class="property-thumbnail">
                                            <div class="offer-type-wrap">
                                                <span class="offer-type bg-<?php echo strtolower('rent'); ?>">Rent</span>
                                            </div>
